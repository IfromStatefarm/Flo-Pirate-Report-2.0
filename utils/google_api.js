...
<<<<<<< Updated upstream
    return aggregateIntelligenceData(data.values || [], startDateStr, endDateStr);
=======
    const rows = data.values || [];
