  ...
  try {
    ...
    for (let i = startIdx; i < rows.length; i++) {
        ...
        for (let j = 0; j < matches.length; j++) {
            ...
            const EXEMPT_WEBSITES = ['varsity.com', 'flosports', 'floracing', 'milesplit', 'houston.flosports.net', 'google.com', 'amazon.com', 'https://flocasts.atlassian.net/', 'https://docs.google.com/','https://gemini.google.com/', 'chatgpt.com', 'https://hockeytech.zen.zixi.com/'];
